...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/iephdevs/script1/master/screenfetch"
...
wget https://raw.githubusercontent.com/iephdevs/script1/master/vnstat_php_frontend-1.5.1.tar.gz
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/iephdevs/script1/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/iephdevs/script1/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/iephdevs/script1/master/mrtg.conf" >> /etc/mrtg.cfg
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/iephdevs/script1/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/iephdevs/script1/master/badvpn-udpgw64"
fi
...
# download script
cd
wget https://raw.githubusercontent.com/iephdevs/script1/master/install-premiumscript.sh -O - -o /dev/null|sh
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/iephdeveloper/iephssh/master/issue.net"
